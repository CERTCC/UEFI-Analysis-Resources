...
[Defines]
  ...
  OUTPUT_DIRECTORY               = Build/FirmwarePerformanceVulRepro
  SUPPORTED_ARCHITECTURES        = IA32|X64
  BUILD_TARGETS                  = NOOPT|DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = FirmwarePerformanceVulReproPkg/FirmwarePerformance.fdf
...
!endif
  ...
  gEfiMdePkgTokenSpaceGuid.PcdDebugPrintErrorLevel|0x804200CF
